...
export const quizQuestions = [
  {
    ...
    "solution": {
      "step1": "Use the vertex form of a quadratic function: $y = a(x - h)^2 + k$, where the turning point (vertex) is $(h, k)$. If $a < 0$, the parabola opens downwards and has a maximum turning point. If $a > 0$, it has a minimum.",
      "step2": [
        "1. Write down the completed square form: $$y = -2(x - 3)^2 + 7$$",
        "2. Identify the parameters: $$a = -2, \\quad h = 3, \\quad k = 7$$",
        "3. Since $(x - 3)^2 \\ge 0$ for all real $x$, multiplying by $-2$ gives: $$-2(x - 3)^2 \\le 0$$",
        "4. The maximum possible value of $y$ occurs when $(x - 3)^2 = 0$, which means: $$x = 3$$",
        "5. Substituting $x = 3$ gives the maximum value: $$y_{\\max} = -2(0)^2 + 7 = 7$$"
      ],
      "step3": "\\mathbf{Maximum\\ turning\\ point\\ at\\ (3, 7)}",
      "trap": "Students frequently see $(x - 3)$ and write $-3$ for the $x$-coordinate. The formula is $(x - h)$, so the sign flips to $+3$. Also, never mistake $a = -2$ for a minimum—a negative leading coefficient always creates a maximum crest."
    }
  },
  {
    "id": "q-m2",
